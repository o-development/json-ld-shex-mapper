import typeFromShex from "../lib/typeFromShex";
import { Schema } from "shexj-traverser";
import * as dom from 'dts-dom';


// NOTE: use test schemas from:
// https://github.com/shexSpec/shexTest/tree/main/schemas
const schema: Schema = {
  type: "Schema",
...
describe("typeFromShex", () => {
  it("Does something", async () => {
    const result = await typeFromShex(schema);
    console.log(result);
  });
});
